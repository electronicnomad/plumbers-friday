...
![create IAM for Session Manager](./create-iam-for-ssm-2.png)
...
![create IAM for Session Manager](./create-iam-for-ssm-4.png)
...
![Session Manager Target Instances](./session-manager-target-instances.png)
