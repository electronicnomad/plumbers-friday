...
그래도 전통적인 레거시 인프라에 비하면, 클라우드 컴퓨팅 세상에서는 정말 단순화
...
개념을 확실히 가지고 있지 않다고 판단이 되시면, [공식 문서](https://docs.aws.amazon.com/ko_kr/vpc/latest/userguide/what-is-amazon-vpc.html)를 읽어보시기 바랍니다.

AWS networking이 찾이하는 그 모든 부분에 대해서 다루는 것은 어려운 일이기도 하고
효용가치가 있는 일이라고도 생각하지는 않습니다.
